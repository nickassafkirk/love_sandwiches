...
def update_worksheet(data, worksheet):
    """
    Receives a list of integers to be inserted into a specified worksheet to update
    worksheet with the data provided
    """
...
def get_last_5_entries_sale():
    """
    Collects collumns of data from sales worksheets, collecting the 
...
def calculate_stock_data(data):
    """
    Calculate the average stock for each day, adding 10%
    """
...
def get_stock_values(data):
    ...
    dict =  {headings[i]:data[i] for i in range(len(headings))}
    return dict
